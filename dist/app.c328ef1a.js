...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"node_modules/parcel-bundler/lib/utils/config.js":[function(require,module,exports) {
"use strict";
...
function _resolve() {
  _resolve = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(filepath, filenames) {
    var root,
        _iterator,
        _step,
        filename,
...
function _load() {
  _load = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(filepath, filenames) {
    var root,
        configFile,
        extname,
        configContent,
...
var _config = require("parcel-bundler/lib/utils/config.js");
...
function _getJokes() {
  _getJokes = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var type,
        query,
        _args2 = arguments;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            type = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : 'random';
...
document.querySelector('[type="submit"]').addEventListener('click', function (event) {
  ...
  console.log(searchData.value); // getJokes('search' ,searchData.value)
...
each(document.querySelectorAll('input[type="radio"]'), function () {
...
},{"axios":"node_modules/axios/index.js","parcel-bundler/lib/utils/config.js":"node_modules/parcel-bundler/lib/utils/config.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
